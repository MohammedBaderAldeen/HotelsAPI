<%@ page import="com.zeon.HotelReservation.Modal.*"%>
	...
	<div class="container text-center">
		...
		<form class="form-horizontal" method="POST" action="save-patient">
			...
			<div class="form-group">
				...
				<div class="col-md-7">
					<input type="text" class="form-control" name="about_hotel"
			...
			<div class="form-group">
				<label class="control-label col-md-3">number_of_room_for_own_person</label>
				<div class="col-md-7">
					<input type="text" class="form-control" name="number_of_room_for_own_person"
			...
			<div class="form-group">
				...
				<div class="col-md-7">
					<input type="text" class="form-control" name="number_of_room_for_two_person"
						value="${hotel.number_of_room_for_two_person}" />
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-md-3">inumber_of_room_for_three_person</label>
				<div class="col-md-7">
					<input type="text" class="form-control" name="number_of_room_for_three_person"
			...
			<div class="form-group">
				...
				<div class="col-md-7">
					<input type="text" class="form-control" name="number_of_room_for_own_person_booking"
			...
			<div class="form-group">
				...
				<div class="col-md-7">
					<input type="text" class="form-control" name="number_of_room_for_two_person_booking"
			...
			<div class="form-group">
				...
				<div class="col-md-7">
					<input type="text" class="form-control" name="number_of_room_for_three_person_booking"
			...
			<div class="form-group">
				...
				<div class="col-md-7">
					<input type="text" class="form-control" name="price_of_personal_room"
			...
			<div class="form-group">
				...
				<div class="col-md-7">
					<input type="text" class="form-control" name="price_of_dual_room"
			...
			<div class="form-group">
				...
				<div class="col-md-7">
					<input type="text" class="form-control" name="price_of_threeperson_room"
